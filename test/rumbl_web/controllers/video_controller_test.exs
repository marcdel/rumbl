defmodule RumblWeb.VideoControllerTest do
  ...
  describe "with a logged-in user" do
    ...
    @create_attrs %{url: "http://youtu.be", title: "vid", description: "a video"}
    @invalid_attrs %{title: "invalid"}

    defp video_count, do: Multimedia.list_videos() |> Enum.count()
    ...
    test "authorizes actions against access by other users", %{conn: conn} do
      owner = user_fixture(username: "someone else")
